...
class LocalStorage {
  ...
  static Future<bool> saveTokens(
    ...
    try {
      ...
      appDebugLog("Error saving tokens: $e");
      return false;
    }
  }
  ...
  static Future<String?> getAccessToken() async {
    try {
      ...
      appDebugLog("Error getting access token: $e");
      return null;
    }
  }
  ...
  static Future<String?> getRefreshToken() async {
    try {
      ...
      appDebugLog("Error getting refresh token: $e");
      return null;
    }
  }
  ...
  static Future<bool> saveDeviceId(String deviceId) async {
    try {
      ...
      appDebugLog("Error saving device ID: $e");
      return false;
    }
  }
  ...
  static Future<String?> getDeviceId() async {
    try {
      ...
      appDebugLog("Error getting device ID: $e");
      return null;
    }
  }
  ...
  static Future<bool> setGuestUserRegistered(bool value) async {
    try {
      ...
      appDebugLog("Error setting guest user registered status: $e");
      return false;
    }
  }
  ...
  static Future<bool> isGuestUserRegistered() async {
    try {
      ...
      appDebugLog("Error checking guest user registered status: $e");
      return false;
    }
  }
  ...
  static Future<bool> clearAuthData() async {
    try {
      ...
      appDebugLog("Error clearing auth data: $e");
      return false;
    }
  }
  ...
  static Future<bool> saveBranchId(String branchId) async {
    try {
      ...
      appDebugLog("Error saving branch ID: $e");
      return false;
    }
  }
  ...
  static Future<String?> getBranchId() async {
    try {
      ...
      appDebugLog("Error getting branch ID: $e");
      return null;
    }
  }
  ...
  static Future<bool> clearBranchId() async {
    try {
      ...
      appDebugLog("Error clearing branch ID: $e");
      return false;
    }
  }
  ...
  static Future<bool> saveOrderType(String orderType) async {
    try {
      ...
      appDebugLog("Error saving order type: $e");
      return false;
    }
  }
  ...
  static Future<String?> getOrderType() async {
    try {
      ...
      appDebugLog("Error getting order type: $e");
      return null;
    }
  }
  ...
  static Future<bool> clearOrderType() async {
    try {
      ...
      appDebugLog("Error clearing order type: $e");
      return false;
    }
  }
  ...
  static Future<bool> saveTableId(String tableId) async {
    try {
      ...
      appDebugLog("Error saving table ID: $e");
      return false;
    }
  }
  ...
  static Future<String?> getTableId() async {
    try {
      ...
      appDebugLog("Error getting table ID: $e");
      return null;
    }
  }
  ...
  static Future<bool> clearTableId() async {
    try {
      ...
      appDebugLog("Error clearing table ID: $e");
      return false;
    }
  }
  ...
  static Future<({String? branchId, String? orderTypeId, String? tableId})>
  getCartPricingContext() async {
    final prefs = await SharedPreferences.getInstance();
    return (
  ...
  static Future<bool> saveCustomerId(int customerId) async {
    try {
      ...
      appDebugLog("Error saving customer ID: $e");
      return false;
    }
  }
  ...
  static Future<int?> getCustomerId() async {
    try {
      ...
      appDebugLog("Error getting customer ID: $e");
      return null;
    }
  }
  ...
  static Future<bool> clearCustomerId() async {
    try {
      ...
      appDebugLog("Error clearing customer ID: $e");
      return false;
    }
  }
  ...
  static Future<bool> saveFcmToken(String fcmToken) async {
    try {
      ...
      appDebugLog("Error saving FCM token: $e");
      return false;
    }
  }
  ...
  @Deprecated(
    'Do not retrieve FCM tokens from local storage. Always fetch from Firebase.',
  )
  static Future<String?> getFcmToken() async {
    try {
      ...
      appDebugLog("Error getting FCM token: $e");
      return null;
    }
  }
  ...
  static Future<bool> clearFcmToken() async {
    try {
      ...
      appDebugLog("Error clearing FCM token: $e");
      return false;
    }
  }
  ...
  static Future<bool> setNotificationPermissionAsked(bool asked) async {
    try {
      ...
      appDebugLog("Error saving notification permission asked status: $e");
      return false;
    }
  }
  ...
  static Future<bool> wasNotificationPermissionAsked() async {
    try {
      ...
      appDebugLog("Error getting notification permission asked status: $e");
      return false;
    }
  }
  ...
  static Future<bool> clearAll() async {
    try {
      ...
      appDebugLog("Error clearing all data: $e");
      return false;
    }
  }
}
